...
class TextFieldBorder extends TextField {
  TextFieldBorder({
    ...
    String? errorText,
    TextStyle? textStyle = const TS.s16w500(colorGray900),
    TextStyle? hintStyle = const TS.s16w500(colorPoint700),
    String? suffixText,
    EdgeInsetsGeometry contentPadding = const EdgeInsets.symmetric(horizontal: 16, vertical: 10),// 높이 최적화
    TextStyle? errorTextStyle = const TS.s12w500(colorRed),
    TextAlignVertical super.textAlignVertical = TextAlignVertical.center,
    Color colorBorder = colorGray300 ,
    Color colorFocused = colorBlack,
    Color colorBorderError = const Color(0xFFDDE1E6),
    double circularNumber = 12,
    super.key,
  }) : super(
          style: textStyle,
          cursorColor: colorPoint700,
